...
- Если сомневаешься в существовании метода/свойства — проверь через доступный MCP-сервер справки 1С
- Используй MCP для верификации доступных API при проектировании
- MCP-справка помогает выбирать правильные методы платформы для архитектурных решений
