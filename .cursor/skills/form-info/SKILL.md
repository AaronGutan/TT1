...
```powershell
powershell.exe -NoProfile -File .cursor/skills/form-info/scripts/form-info.ps1 -FormPath "<путь к Form.xml>"
```

С пагинацией:
```powershell
powershell.exe -NoProfile -File .cursor/skills/form-info/scripts/form-info.ps1 -FormPath "<путь>" -Offset 150
```
